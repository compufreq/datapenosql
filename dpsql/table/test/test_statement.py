from dpsql.table.model.criterion_obj import ValCriterion, CriterionClause, AttrCriterion, Criterion
...
statement_test = Statement(criteria=[criteria1], clause=StatementClause.Where)
